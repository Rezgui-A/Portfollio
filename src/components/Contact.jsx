const socialLinks = [
    {
      href: 'https://github.com/Rezgui-A/',
    ...
    {
      href: 'https://www.linkedin.com/in/adam-rezgui/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section id = "contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg-items-stretch">
            ...
            <form action ="https://getform.io/f/blllywxb" method = "POST" className="xl:pl-10 2xl:pl-20">
                <div className="mb:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required
                        placeholder="rezgui.adam004@gmail.com"
