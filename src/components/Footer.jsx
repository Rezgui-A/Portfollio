    ...
    return (
      <footer className="section">
          ...
          <div className="mb-10">
              ...
              <ButtonPrimary href = "mailto:rezgui.adam004@gmail.com" label = "Start project" icon = "chevron_right" className="reveal-up"/>
              </div>
          ...
          <div className="flex items-center justify-between pt-10 mb-8">
            <a href = "/" className="logo reveal-up">
              <img src= "/images/logo.svg" alt = "Logo" width={40} height={40} className ="text-zinc-400"/> 
            </a>
        <p className="text-zinc-500 text-sm reveal-up">
          &copy;2024 <span className="text-zinc-200">Adam Rezgui</span>
        </p>
